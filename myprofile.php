...
<body>
  <header>
     <nav class="navbar navbar-light bg-light justify-content-between rounded">
      <h1 class="navbar-brand">Employee | Succor</h1>
      <ul id="navli">
                <li><button><a class="homeblack" href="eloginwel.php?id=<?php echo $id?>" class="btn btn-outline-info y-2 my-sm-0" type="button">HOME</a></button></li>
                <li><button><a class="homered" href="myprofile.php?id=<?php echo $id?>" class="btn btn-outline-info y-2 my-sm-0" type="button">My Profile</a></button></li>
                <li><button><a  class="homeblack" href="empproject.php?id=<?php echo $id?>" class="btn btn-outline-success y-2 my-sm-0" type="button">My Projects</a></button></li>
                <li><button><a class="homeblack" href="applyleave.php?id=<?php echo $id?>" class="btn btn-outline-success y-2 my-sm-0" type="button">Apply Leave</a></button></li>
                <li><button><a class="homeblack" href="elogin.html" class="btn btn-outline-success y-2 my-sm-0" type="button">Log Out</a></button></li>
