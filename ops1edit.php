...
if(isset($_POST['update'])){
 ...
 $result = mysqli_query($conn, "UPDATE `ops1data` SET `status`='$status' WHERE id=$id1");
        ...
        <div class="wrapper wrapper--w680">
            <div class="card card-1">
                ...
                <div class="card-body">
                    ...
                    <form id = "registration" action="ops1edit.php?id1=<?php echo $id1;?>&id=<?php echo $id;?>" method="POST">
