...
$result = mysqli_query($conn, "UPDATE `ops3vendordata` SET `vendorstatus`='$vendorstatus' WHERE id=$id1");
                        ...
                        <div class="row row-space">
                            <div class="col-6">
                                <div class="input-group">
                                     <input class="input--style-1" type="text" placeholder="Vendor Status" name="vendorstatus" value="<?php echo $vendorstatus;?>" >
                                </div>
                            </div>
