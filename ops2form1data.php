...
$id = $_GET['id'];
$sql = "SELECT * from `employee` , `ops2form1` WHERE employee.`id` = ops2form1.`empid` AND ops2form1.`empid` = $id ORDER BY ops2form1.`id` DESC";
    ...
    <div id="main-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 col-8 align-self-center">
                        <h3 class="text-themecolor m-b-0 m-t-0">CLIENT DATA</h3>
                        <ol class="breadcrumb">
        ...
        <tbody id="myTable">
                ...
                while ($employee = mysqli_fetch_assoc($result)) {
                    ...
                    echo "<td><a href=\"ops2data1edit.php?id1=$employee[id]&id=$id\"><i class='mdi mdi-table-edit'></i>Edit</a></td>";
