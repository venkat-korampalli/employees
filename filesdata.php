...
$sql5 = "SELECT * FROM `quickfiles` WHERE empid=$id";
            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 col-8 align-self-center">
                        <h3 class="text-themecolor m-b-0 m-t-0">QUICK FILES UPLOAD</h3>
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="">Home</a></li>
                            <li class="breadcrumb-item active">Quick Files Upload</li>
                        </ol>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12 col-xlg-3 col-md-5">
                        <div class="card">
                            <div class="card-block">
                                <form action="filesdatasubmit.php?id=<?php echo $id?>" method="POST" enctype="multipart/form-data" class="form-horizontal form-material">
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-12"></label>
                                        <div class="col-md-12">
                                            <input type="number" placeholder="Enter Contact Number" name="contact" required="required" class="form-control form-control-line" value="" >
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-12"></label>
                    ...
                    <div class="col-lg-12 col-xlg-9 col-md-7">
                        <div class="card">
                            <div class="card-block">
                                <h4 class="card-title">Candidates Resumes</h4>
                ...
                <th align = "center">no of. downloads</th>
                <th align = "center">Resume downloads</th>
               ...
               <?php
                while ($alogin = mysqli_fetch_assoc($result5)) {
                    ...
                    echo "<td>".$alogin['cresume']."</td>";
                    echo "<td>".$alogin['size']."</td>";
                    echo "<td>".$alogin['downloads']."</td>";
                    echo "<td><a href=\"quickfiles.php?file_id=$alogin[id]\"><i class='mdi mdi-download'></i>Download</a></td>";
