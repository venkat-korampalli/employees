...
$id = $_GET['id'];
$sql = "SELECT COUNT(DISTINCT subcount.id_1) AS CountOf, subcount.name, subcount.date, subcount.empid, calendar.cdate FROM subcount, calendar WHERE subcount.date = calendar.cdate GROUP BY subcount.`date`, subcount.`empid` ORDER BY subcount.id_1 DESC";
/*$sql= "SELECT  subcount.empid 
        , subcount.name
        , subcount.date
        , calendar.cdate
FROM    subcount, calendar
INNER JOIN  
(
            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 col-8 align-self-center">
                        <h3 class="text-themecolor m-b-0 m-t-0">EVERYDAY SUBMISSION COUNT</h3>
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="index.php?id=<?php echo $id?>">Home</a></li>
                            <li class="breadcrumb-item active">Everyday Submission Count</li>
                        </ol>
                    </div>
              ...
              $ret=mysqli_query($conn,"SELECT * from subcount");
                    if ($ret)
  {
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-block">
                                <h2 class="card-title">Everyday Submission Count</h2>
                                <h6 class="card-subtitle">Always <code>.remember</code></h6>
                                <div class="table-responsive">
                                    <table class="table table-striped table-hover table-bordered" id="ops3">
