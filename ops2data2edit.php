...
if(isset($_POST['update']))
{
	...
	$requirementn = mysqli_real_escape_string($conn, $_POST['requirement']);
	...
	<div class="page-wrapper bg-blue p-t-100 p-b-100 font-robo">
        <div class="wrapper wrapper--w680">
            <div class="card card-1">
                ...
                <div class="card-body">
                    <h2 class="title">UPDATE PROFILES INFO</h2>
                    <form id = "registration" action="ops2data2edit.php?id1=<?php echo $id1;?>&id=<?php echo $id;?>" method="POST">

                        <div class="row row-space">
                            <div class="col-2">
                                <div class="input-group">
                                     <input class="input--style-1" type="text" name="date" value="<?php echo $date;?>" readonly>
                                </div>
                            </div>
                            <div class="col-2">
                                <div class="input-group">
                                    <input class="input--style-1" type="text" name="client" value="<?php echo $client;?>"readonly>
                                </div>
                            </div>
                        </div>
                        <div class="input-group">
                        ...
                        <div class="row row-space">
                            <div class="col-2">
                                <div class="input-group">
                                    <input class="input--style-1" type="text" name="location" value="<?php echo $location;?>" readonly>
                                   
                                </div>
                            </div>
                            <div class="col-2">
                                <div class="input-group">
									<input class="input--style-1" type="text" name="candidatename" value="<?php echo $candidatename;?>" readonly>
                                </div>
                            </div>
                        </div>
                        
                        <div class="input-group">
                            <input class="input--style-1" type="text" name="candidatenumber" value="<?php echo $candidatenumber;?>" readonly>
                        </div>
