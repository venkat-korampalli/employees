...
$id = $_GET['id'];
$sql = "SELECT * from `employee` , `ops4data` WHERE employee.`id` = ops4data.`empid` AND ops4data.`empid` = $id ORDER BY ops4data.`id` DESC";
    ...
    <div id="main-wrapper">
        ...
        <tbody id="myTable">
                ...
                while ($employee = mysqli_fetch_assoc($result)) {
                    ...
                    echo "<td><a href=\"ops4dataedit.php?id1=$employee[id]&id=$id\"><i class='mdi mdi-table-edit'></i>Edit</a></td>";
                   //  | <a href=\".php?id=$employee[id]\" onClick=\"return confirm('Are you sure you want to delete?')\"><i class='mdi mdi-delete'></i>Delete</a>
                    echo "</tr>";
