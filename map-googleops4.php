            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 col-8 align-self-center">
                        <h3 class="text-themecolor m-b-0 m-t-0">OPS4 SUBMISSION FORM</h3>
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="index.php?id=<?php echo $id?>">Home</a></li>
                            <li class="breadcrumb-item active">OPS4 Submission Form</li>
                        </ol>
                    </div>
                ...
                <div class="row">
                   ...
                   <!-- <div class="col-lg-4 col-xlg-3 col-md-5">
                    ...
                    <div class="col-lg-12 col-xlg-9 col-md-7">
                        <div class="card">
                            <div class="card-block">
                                <h2 class="title">OPS4 Submission Form</h2><br>
                                <form action="ops4submit.php?id=<?php echo $id?>" method="POST"  class="form-horizontal form-material">
                                    <div class="form-group">
                                        <label class="col-md-12"></label>
                                        <div class="col-md-12">
                                            <input type="number" placeholder="Project Id" name="cprojectid" required="required"class="form-control form-control-line" value="" >
                                        </div>
                                    <div class="form-group">
                                        <label class="col-md-12"></label>
                                        <div class="col-md-12">
                                            <input type="text" placeholder="Succor recruiter" class="form-control form-control-line" value="" name="succorrecruiter" >
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-12"></label>
                                        <div class="col-md-12">
                                            <input type="text" placeholder="Candidate Name" class="form-control form-control-line" name="ccandidatename" value="" >
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="example-email" class="col-md-12"></label>
                                        <div class="col-md-12">
                                            <input type="text" name="ctechnology" placeholder="Technology" class="form-control form-control-line" value=""  id="example-email" >
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="example-email" class="col-md-12"></label>
                                        <div class="col-md-12">
                                     <input type="text" placeholder="Candidate Location" name="ccandidatelocation" required="required" class="form-control form-control-line" id="example-email" value="" >
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-12"></label>
                                        <div class="col-md-12">
                                         <input type="text" placeholder="Candidate Visa status" name="ccandidatevisastatus" required="required" class="form-control form-control-line" value="" >
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-12"></label>
                                        <div class="col-md-12">
                                            <input type="text" placeholder="Rate" name="crate" required="required" class="form-control form-control-line" value="" >
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-12"></label>
                                        <div class="col-md-12">
                                            <input type="email" placeholder="Candidate Email" name="cemail" required="required" class="form-control form-control-line" value="" >
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-12"></label>
                                        <div class="col-md-12">
                                            <input type="number" placeholder="Vendor Number" name="cnumber" required="required" class="form-control form-control-line" value="" >
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="example-email" class="col-md-12">Submission Date</label>
                                        <div class="col-md-12">
                                            <input type="date" placeholder="Submission Date" name="csubmissiondate" required="required" class="form-control form-control-line" id="example-email">
                                        </div>
                                    </div>
                                <!--<div class="form-group">
                                        <label class="col-md-12"></label>
                                        <div class="col-md-12">
                                            <input type="text" placeholder="Submission Date" name="csubmissiondate" class="form-control form-control-line" value="" >
                                        </div>
                                    </div> -->
                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-12">
                                            <button class="btn btn-success float-right" name="send" type="submit">Submit</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
