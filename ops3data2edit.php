...
$result = mysqli_query($conn, "UPDATE `ops3data2` SET `submissionstatus`='$submissionstatus' WHERE id=$id1");
	...
	<div class="page-wrapper bg-blue p-t-100 p-b-100 font-robo">
        <div class="wrapper wrapper--w680">
            <div class="card card-1">
                ...
                <div class="card-body">
                    <h2 class="title">Update OPS3data</h2>
                    <form id = "registration" action="ops3data2edit.php?id1=<?php echo $id1;?>&id=<?php echo $id;?>" method="POST">
