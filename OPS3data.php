...
$id = $_GET['id'];
$sql = "SELECT * from `employee` , `ops3data` WHERE employee.`id` = ops3data.`empid` AND ops3data.`empid` = $id ORDER BY ops3data.`id` DESC";
    ...
    <div id="main-wrapper">
        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <strong class="text-black float-right"><b>Submission Count:</b><i>&nbsp<?php 
              $ret=mysqli_query($conn,"SELECT * from ops3data where empid='$id'");
                    if ($ret)
  {
  // Return the number of rows in result set
  $rowcount=mysqli_num_rows($ret);
  printf("You Submitted %d Profiles .\n",$rowcount);
  // Free result set
  mysqli_free_result($ret);
        ...
        <tbody id="myTable">
                ...
                while ($employee = mysqli_fetch_assoc($result)) {
                    ...
                    echo "<td><a href=\"ops3dataedit.php?id1=$employee[id]&id=$id\"><i class='mdi mdi-table-edit'></i>Edit</a></td>";
