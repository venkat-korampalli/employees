            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 col-8 align-self-center">
                        <h3 class="text-themecolor">OPS3 SUBMISSION FORM</h3>
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="">Home</a></li>
                            <li class="breadcrumb-item active">OPS3 Submission Form</li>
                        </ol>
                    </div>
                    ...
                    <div class="col-lg-12 col-xlg-3 col-md-5">
                        <div class="card">
                            <div class="card-block">
                                ...
                                <form action="ops3submit.php?id=<?php echo $id?>" method="POST" enctype="multipart/form-data"  class="form-horizontal form-material">
                                   <!-- <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-12">
                                            <button class="btn btn-info float-right" name="send" type="submit" value="">Submit</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
