...
<head>
    ...
    <title>SuccorTechnologies | Employee Management | Employee Login Timings</title>
    <!-- Bootstrap Core CSS -->
            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 col-8 align-self-center">
                        <h3 class="text-themecolor m-b-0 m-t-0">MY EVERYDAY LOGIN TIMINGS</h3>
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                            <li class="breadcrumb-item active">My Everyday login Timings</li>
                        </ol>
                    </div>
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-block">
                                <h2 class="card-title">MY EVERYDAY LOGIN TIMINGS</h2>
                                <h6 class="card-subtitle">Time is <code>.Precious</code></h6>
                ...
                while ($login = mysqli_fetch_assoc($result)) {
                    echo "<tr>";
                    echo "<td>".$login['id']."</td>";
                    echo "<td>".$login['empid']."</td>";
                    echo "<td>".$login['logindate']."</td>"; 
                    echo "<td>".$login['logintime']."</td>";    
