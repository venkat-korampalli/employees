            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 col-8 align-self-center">
                        <h3 class="text-themecolor m-b-0 m-t-0">OPS0 CONSULTANTS</h3>
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="index.php?id=<?php echo $id?>">Home</a></li>
                            <li class="breadcrumb-item active">OPS0 Consultants</li>
                        </ol>
                    </div>
                ...
                <div class="row">
                   ...
                   <!-- <div class="col-lg-4 col-xlg-3 col-md-5">
                    ...
                    <div class="col-lg-12 col-xlg-9 col-md-7">
                        <div class="card">
                            <div class="card-block">
                                <h2 class="title">OPS0 Consultants Form</h2><br>
                                <form action="ops0submit2.php?id=<?php echo $id?>" method="POST"  class="form-horizontal form-material">
                                    <div class="form-group">
                                        <label class="col-md-12"></label>
                                        <div class="col-md-12">
                                            <input type="text" placeholder="Succor Employee" name="succoremployee" required="required"class="form-control form-control-line" value="" >
                                        </div>
                                    <div class="form-group">
                                        <label class="col-md-12"></label>
                                        <div class="col-md-12">
                                            <input type="text" placeholder="Consultant Name" class="form-control form-control-line" value="" required="required" name="consultantname" >
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-12"></label>
                                        <div class="col-md-12">
                                            <input type="text" placeholder="Consultant Email Id" required="required" class="form-control form-control-line" name="consultantemailid" value="" >
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="example-email" class="col-md-12"></label>
                                        <div class="col-md-12">
                                            <input type="number" name="consultantcontactnumber" placeholder="Consultant Contact Number" class="form-control form-control-line" value="" required="required" id="example-email" >
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-12"></label>
                                        <div class="col-md-12">
                                            <input type="text" name="technology" placeholder="Technology" required="required" class="form-control form-control-line" value=""  >
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="example-email" class="col-md-12"></label>
                                        <div class="col-md-12">
                                     <input type="text" placeholder="Visa Status" name="visastatus" required="required" class="form-control form-control-line" id="example-email" value="" >
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-12"></label>
                                        <div class="col-md-12">
                                         <input type="text" placeholder="Contract" name="contract" required="required" class="form-control form-control-line" value="" >
                                        </div>
                                    </div>
                                     <div class="form-group">
                                        <label class="col-md-12"></label>
                                        <div class="col-md-12">
                                            <input type="text" placeholder="Certification" name="certification" required="required" class="form-control form-control-line" value="" >
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-12"></label>
                                        <div class="col-md-12">
                                            <input type="text" placeholder="Consultant Linkedin" name="consultantlinkedin" required="required" class="form-control form-control-line" value="" >
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-12"></label>
                                        <div class="col-md-12">
                                            <input type="text" placeholder="Status" name="status" required="required"class="form-control form-control-line" value="">
                                        </div>
                                    </div>
