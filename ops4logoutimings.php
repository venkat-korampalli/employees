...
$id = $_GET['id'];
$sql = "SELECT * from userlog_us where empid=$id ORDER BY id DESC";
//$sql2 = "SELECT COUNT(*) from employee where empid=$id";
...
<head>
    ...
    <title>SuccorTechnologies | Employee Management | Employee Logout Timings</title>
    <!-- Bootstrap Core CSS -->
            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 col-8 align-self-center">
                        <h3 class="text-themecolor m-b-0 m-t-0">MY EVERYDAY LOGOUT TIMINGS</h3>
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                            <li class="breadcrumb-item active">My Everyday Logout Timings</li>
                        </ol>
                    </div>
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-block">
                                <h2 class="card-title">MY EVERYDAY LOGOUT TIMINGS</h2>
                                <h6 class="card-subtitle">Utilize the time <code>.Wisely</code></h6>
                ...
                <th align = "center">Logout Date</th>
                ...
                while ($logout = mysqli_fetch_assoc($result)) {
                    echo "<tr>";
                    echo "<td>".$logout['id']."</td>";
                    echo "<td>".$logout['empid']."</td>";
                    echo "<td>".$logout['logoutdate']."</td>"; 
                    echo "<td>".$logout['logouttime']."</td>";    
