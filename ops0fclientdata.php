...
$id = $_GET['id'];
$sql = "SELECT * from `employee` , `ops0futureclients` WHERE employee.`id` = ops0futureclients.`empid` AND ops0futureclients.`empid` = $id ORDER BY ops0futureclients.`id` DESC";
    ...
    <div id="main-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 col-8 align-self-center">
                        <h3 class="text-themecolor m-b-0 m-t-0">OPS0 FUTURE CLIENTS DATA</h3>
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="index.php?id=<?php echo $id?>">Home</a></li>
                            <li class="breadcrumb-item active">OPS0 Future Clients Data</li>
                        </ol>
                    </div>
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-block">
                                <h2 class="card-title">OPS0 Future Clients Data</h2>
        ...
        <tbody id="myTable">
                ...
                while ($employee = mysqli_fetch_assoc($result)) {
                    ...
                    echo "<td><a href=\"ops0fclientedit.php?id1=$employee[id]&id=$id\"><i class='mdi mdi-table-edit'></i>Edit</a></td>";
