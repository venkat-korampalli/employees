...
$id = $_GET['id'];
$sql = "SELECT * from `ops3wglbenchdata` ORDER BY ops3wglbenchdata.`id` DESC";
//$sql = "SELECT * from `employee` , `ops3wglbenchdata` WHERE employee.`id` = ops3wglbenchdata.`empid` AND ops3wglbenchdata.`empid` = $id";
...
$(document).ready(function(){
  $("#myInput").on("keyup", function() {
    ...
    <div id="main-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 col-8 align-self-center">
                        <h3 class="text-themecolor m-b-0 m-t-0">OPS3-WGL BENCH DATA</h3>
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="">Home</a></li>
                            <li class="breadcrumb-item active">OPS3-Wgl Bench Data</li>
                        </ol>
                    </div>
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-block">
                                <h2 class="card-title">OPS3-WGL Bench Data</h2>
        ...
        <tbody id="myTable">
                <?php
                while ($alogin = mysqli_fetch_assoc($result)) {
                    echo "<tr>";
                ...
                //    echo "<td>".$alogin['assigned']."</td>";
                 //   echo "<td><a href=\".php?id1=$alogin[id]&id=$id\">Edit</a></td>";
                    //| <a href=\".php?id1=$alogin[id]&id=$id\" onClick=\"return confirm('Are you sure you want to delete?')\">Delete</a>
