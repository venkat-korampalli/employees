...
$id = $_GET['id'];
$sql = "SELECT * FROM `ops3benchdata` ORDER BY ops3benchdata.`id` DESC";
            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 col-8 align-self-center">
                        <h3 class="text-themecolor m-b-0 m-t-0">OPS3 BENCH CONSULTANTS</h3>
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="index.php?id=<?php echo $id?>">Home</a></li>
                            <li class="breadcrumb-item active">OPS3 Bench Consultants</li>
                        </ol>
                    </div>
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-block">
                                <h2 class="card-title">OPS3 Bench Consultants</h2>
                                <h6 class="card-subtitle">Always Keep Your Data <code>.Secure</code></h6>
