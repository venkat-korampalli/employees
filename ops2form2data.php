...
$id = $_GET['id'];
$sql = "SELECT * from `employee` , `ops2form2` WHERE employee.`id` = ops2form2.`empid` AND ops2form2.`empid` = $id ORDER BY ops2form2.`id` DESC";
    ...
    <div id="main-wrapper">
        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <th align = "center">Client Status</th>
        ...
        <tbody id="myTable">
                ...
                while ($employee = mysqli_fetch_assoc($result)) {
                   ...
                   // echo "<td>".$employee['weblink']."</td>";
                    ...
                    echo "<td><a href=\"ops2data2edit.php?id1=$employee[id]&id=$id\"><i class='mdi mdi-table-edit'></i>Edit</a></td>";
