...
$sql = "SELECT * from `employee` , `ops0data2` WHERE employee.`id` = ops0data2.`empid` ORDER BY ops0data2.`id` DESC";
    ...
    <div id="main-wrapper">
        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-7 col-8 align-self-center">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item float-right"><a href="ops0wvendordata.php?id=<?php echo $id?>">OPS0WVendors</a></li>
                            <li class="breadcrumb-item float-right"><a href="ops0ideadata.php?id=<?php echo $id?>">OPS0Ideas</a></li>
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-block">
                                <h2 class="card-title">OPS0 Consultant Data</h2>
                ...
                <th align = "center">Consultant Email Id</th>
                <th align = "center">Consultant Contact Number</th>
                <th align = "center">Technology</th>
                <th align = "center">Visa Status</th>
                <th align = "center">Contract</th>
                <th align = "center">Certification</th>
                <th align = "center">Consultant Linkedin</th>
        ...
        <tbody id="myTable">
                ...
                while ($employee = mysqli_fetch_assoc($result)) {
                    ...
                    echo "<td>".$employee['consultantname']."</td>";
                    echo "<td>".$employee['consultantemailid']."</td>";
                    echo "<td>".$employee['consultantcontactnumber']."</td>";
                    echo "<td>".$employee['technology']."</td>";
                    echo "<td>".$employee['visastatus']."</td>";
                    echo "<td>".$employee['contract']."</td>";
                    echo "<td>".$employee['certification']."</td>";
                    echo "<td>".$employee['consultantlinkedin']."</td>";
                    echo "<td>".$employee['status']."</td>";
                   

                    echo "<td><a href=\"ops0data2edit.php?id1=$employee[id]&id=$id\"><i class='mdi mdi-table-edit'></i>Edit</a> | <a href=\"ops0data2delete.php?id1=$employee[id]&id=$id\" onClick=\"return confirm('Are you sure you want to delete?')\"><i class='mdi mdi-delete'></i>Delete</a></td>";
                    echo "</tr>";
