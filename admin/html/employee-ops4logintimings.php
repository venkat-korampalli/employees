...
$sql = "SELECT * from `userlog_us` , `employee` WHERE employee.`id` = userlog_us.`empid` ORDER BY userlog_us.`id` DESC";
...
<head>
    ...
    <title>SuccorTechnologies | Employee Management | Employee OPS4 LoginTimings</title>
    <!-- Bootstrap Core CSS -->
    ...
    <div id="main-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 col-8 align-self-center">
                        <h3 class="text-themecolor m-b-0 m-t-0">EMPLOYEE OPS3-4 LOGIN-OUT TIMINGS </h3>
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                            <li class="breadcrumb-item active">Employee OPS3-4 Login-Out Timings</li>
                        </ol>
                    </div>
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-block">
                                <h2 class="card-title">Employees OPS3 & 4 Work Login and Out Timings </h2>
        ...
        <tbody id="myTable">
                ...
                while ($employee = mysqli_fetch_assoc($result)) {
                    ...
                    echo "<td>".$employee['logindate']."</td>";
                    echo "<td>".$employee['logintime']."</td>";
                    echo "<td>".$employee['logoutdate']."</td>";
                    echo "<td>".$employee['logouttime']."</td>";
