...
$sql = "SELECT * from `employee` , `ops0futureclients` WHERE employee.`id` = ops0futureclients.`empid` ORDER BY ops0futureclients.`id` DESC";
    ...
    <div id="main-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-7 col-8 align-self-center">
                        <h3 class="text-themecolor m-b-0 m-t-0">OPS0 FUTURE CLIENT </h3>
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                            <li class="breadcrumb-item active">OPS0 Future Client </li>
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-block">
                                <h2 class="card-title">OPS0 Future Client Data</h2>
                ...
                <th align = "center">Client Email</th>
                <th align = "center">Client Designation</th>
                <th align = "center">Client Location</th>
                <th align = "center">Client Contact Account</th>
                <th align = "center">Feedback</th>
                <th align = "center">Client Contact Id</th>
        ...
        <tbody id="myTable">
                ...
                while ($employee = mysqli_fetch_assoc($result)) {
                    ...
                    echo "<td>".$employee['clientcontact']."</td>";
                    echo "<td>".$employee['clientemail']."</td>";
                    echo "<td>".$employee['clientdesignation']."</td>";
                    echo "<td>".$employee['clientlocation']."</td>";
                    echo "<td>".$employee['clientcontactaccount']."</td>";
                    echo "<td>".$employee['feedback']."</td>";
                    echo "<td>".$employee['clientcontactid']."</td>";


                    echo "<td><a href=\"ops0fclientedit.php?id1=$employee[id]&id=$id\"><i class='mdi mdi-table-edit'></i>Edit</a>| <a href=\"ops0fclientdelete.php?id1=$employee[id]&id=$id\" onClick=\"return confirm('Are you sure you want to delete?')\"><i class='mdi mdi-delete'></i>Delete</a></td>";
