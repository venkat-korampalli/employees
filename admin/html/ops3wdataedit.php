...
$sql = "SELECT * FROM `ops3data2` WHERE 1";
...
<?php
	$id1 = (isset($_GET['id1']) ? $_GET['id1'] : '');
    $id = (isset($_GET['id']) ? $_GET['id'] : '');
	$sql = "SELECT * from `ops3data2` WHERE id=$id1";
	$result = mysqli_query($conn, $sql);
	if($result){
	...
	<div class="page-wrapper bg-blue p-t-100 p-b-100 font-robo">
        <div class="wrapper wrapper--w680">
            <div class="card card-1">
                ...
                <div class="card-body">
                    <h2 class="title">Update OPS3 data</h2>
                    <form id = "registration" action="ops3wdataedit.php?id1=<?php echo $id1;?>&id=<?php echo $id;?>" method="POST">
