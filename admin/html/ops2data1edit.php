	...
	<div class="page-wrapper bg-blue p-t-100 p-b-100 font-robo">
        <div class="wrapper wrapper--w680">
            <div class="card card-1">
                ...
                <div class="card-body">
                    <h2 class="title">Update OPS2 Client Info</h2>
                    <form id = "registration" action="ops2data1edit.php?id1=<?php echo $id1;?>&id=<?php echo $id;?>" method="POST">

                        <div class="row row-space">
                            <div class="col-2">
                                <div class="input-group">
                                     <input class="input--style-1" type="text" name="clientname" value="<?php echo $clientname;?>">
                                </div>
                            </div>
                            <div class="col-2">
                                <div class="input-group">
                                    <input class="input--style-1" type="text" name="clientlocation" value="<?php echo $clientlocation;?>">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="input-group">
                            <input class="input--style-1" type="text"  name="contactperson" value="<?php echo $contactperson;?>">
                        </div>
                        <div class="row row-space">
                            <div class="col-2">
                                <div class="input-group">
                                    <input class="input--style-1" type="text" name="contactnumber" value="<?php echo $contactnumber;?>">
                        ...
                        <div class="input-group">
                            <input class="input--style-1" type="text" name="weblink" value="<?php echo $weblink;?>">
                        </div>
                        ...
                        <div class="input-group">
                         ...
                         <div class="input-group">
                            <input class="input--style-1" type="text"  name="requirementlocation" value="<?php echo $requirementlocation;?>">
                        </div>

                        <div class="input-group">
                            <input class="input--style-1" type="text" name="quantity" value="<?php echo $quantity;?>">
                        </div>

                        <div class="input-group">
                            <input class="input--style-1" type="text" name="visitedby" value="<?php echo $visitedby;?>">
                        </div>
                        <div class="input-group">
                            <input class="input--style-1" type="text" name="value" value="<?php echo $value;?>">
                        </div>
                        <div class="input-group">
