	...
	<div class="page-wrapper bg-blue p-t-100 p-b-100 font-robo">
        <div class="wrapper wrapper--w680">
            <div class="card card-1">
                ...
                <div class="card-body">
                    <h2 class="title">UPDATE OPS4 SUBMISSION INFO</h2>
                    <form id = "registration" action="ops4dataedit.php?id1=<?php echo $id1;?>&id=<?php echo $id;?>" method="POST">

                        <div class="row row-space">
                            <div class="col-2">
                                <div class="input-group">
                                     <input class="input--style-1" type="text" name="succorrecruiter" value="<?php echo $succorrecruiter;?>">
                                </div>
                            </div>
                            <div class="col-2">
                                <div class="input-group">
                                    <input class="input--style-1" type="text" name="ccandidatename" value="<?php echo $ccandidatename;?>">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="input-group">
                            <input class="input--style-1" type="text"  name="ctechnology" value="<?php echo $ctechnology;?>">
                        </div>
                        <div class="row row-space">
                            <div class="col-2">
                                <div class="input-group">
                                    <input class="input--style-1" type="text" name="ccandidatelocation" value="<?php echo $ccandidatelocation;?>">
                                   
                                </div>
                            </div>
                            <div class="col-2">
                                <div class="input-group">
									<input class="input--style-1" type="text" name="ccandidatevisastatus" value="<?php echo $ccandidatevisastatus;?>">
                                </div>
                            </div>
                        </div>
                        
                        <div class="input-group">
                            <input class="input--style-1" type="text" name="crate" value="<?php echo $crate;?>">
                        </div>

                        <div class="input-group">
                            <input class="input--style-1" type="text" name="cemail" value="<?php echo $cemail;?>">
                        </div>

                        
                         <div class="input-group">
                            <input class="input--style-1" type="text"  name="cnumber" value="<?php echo $cnumber;?>">
                        </div>

                        <div class="input-group">
                            <input class="input--style-1" type="text" name="csubmissiondate" value="<?php echo $csubmissiondate;?>">
                        </div>
