...
$sql = "SELECT * from `project` WHERE project.ops='admin-OPS2,3-WL&HYD,OPS4' order by subdate desc";
        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-block">
                                <h2 class="card-title">Employee Ranking Table</h2>
                ...
                while ($employee = mysqli_fetch_assoc($result)) {
                    ...
                    echo "<td><a href=\"mark.php?id=$employee[eid]&pid=$employee[pid]\"><i class='mdi mdi-check'></i>Mark</a>"; 
                    echo "<td><a href=\"empprojectsdelete.php?id=$employee[eid]&pid=$employee[pid]\"><i class='mdi mdi-close'></i>Delete</a>";
