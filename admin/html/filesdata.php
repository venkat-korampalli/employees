...
require_once ('process/session.php');
 ...
 if(!isset($_SESSION['userid'])){
    ...
    $sql5 = "SELECT * FROM `quickfiles` WHERE 1";
            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 col-8 align-self-center">
                        <h3 class="text-themecolor">QUICK FILES</h3>
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="">Home</a></li>
                            <li class="breadcrumb-item active">Quick Files</li>
                        </ol>
                    </div>
                            ...
                            <div class="card-block">
                                <form action="filesdatasubmit.php?id=<?php echo $id?>" method="POST" enctype="multipart/form-data" class="form-horizontal form-material">
                                  ...
                                  <!--   <div class="form-group">
                                   ...
                                   <div class="form-group">
                                        <div class="col-sm-12">
                                            <button class="btn btn-info float-right" name="submit" type="submit">Submit Info</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
