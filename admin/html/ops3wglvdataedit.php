...
$sql = "SELECT * FROM `ops3wglvendordata` WHERE 1";
...
$result = mysqli_query($conn, "UPDATE `ops3wglvendordata` SET `vendorname`='$vendorname',`vendoremail`='$vendoremail',`vendorcontact`='$vendorcontact',`vendorcompany`='$vendorcompany',`vendorstatus`='$vendorstatus' WHERE id=$id1");
	echo ("<SCRIPT LANGUAGE='JavaScript'>
    window.alert('Succesfully Updated')
    window.location.href='ops3wglvdata.php?id=$id';
    </SCRIPT>");
...
<?php
	$id1 = (isset($_GET['id1']) ? $_GET['id1'] : '');
    $id = (isset($_GET['id']) ? $_GET['id'] : '');
	$sql = "SELECT * from `ops3wglvendordata` WHERE id=$id1";
	$result = mysqli_query($conn, $sql);
	if($result){
	...
	<div class="page-wrapper bg-blue p-t-100 p-b-100 font-robo">
        <div class="wrapper wrapper--w680">
            <div class="card card-1">
                ...
                <div class="card-body">
                    <h2 class="title">UPDATE WGL OPS3 VENDOR DATA</h2>
                    <form id = "registration" action="ops3wglvdataedit.php?id1=<?php echo $id1;?>&id=<?php echo $id;?>" method="POST">
