...
$sql = "SELECT * from `ops4vendordata` order by `ops4vendordata`.id desc";
    ...
    <div id="main-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-7 col-8 align-self-center">
                        <h3 class="text-themecolor m-b-0 m-t-0">OPS4 VENDORS DATA</h3>
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                            <li class="breadcrumb-item active">OPS4 Vendors Data</li>
                            <li class="breadcrumb-item float-right"><a href="OPS4data.php?id=<?php echo $id?>"> Submission</a></li>
                            <li class="breadcrumb-item float-right"><a href="ops4data3.php?id=<?php echo $id?>"> Consultant</a></li>
                    ...
                    <div class="col-lg-12 col-xlg-3 col-md-5">
                        <div class="card">
                            <div class="card-block">
                                <form action="ops4vsubmit.php?id=<?php echo $id?>" method="POST" class="form-horizontal form-material">
                                    <div class="form-group">
                                        <label class="col-md-12"></label>
                                        <div class="col-md-12">
                                            <input type="text" placeholder="Enter Vendor Name" class="form-control form-control-line" value="" name="vname" >
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="example-email" class="col-md-12"></label>
                                        <div class="col-md-12">
                                            <input type="email" name="vemail" placeholder="Enter Email Id" class="form-control form-control-line" value=""  id="example-email" >
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-12"></label>
                                        <div class="col-md-12">
                                            <input type="number" placeholder="Enter Contact Number" name="vcontact" required="required" class="form-control form-control-line" value="" >
                                        </div>
                                    </div>
                                     <div class="form-group">
                                        <label class="col-md-12"></label>
                                        <div class="col-md-12">
                                            <input type="text" placeholder="Enter Vendor Company" class="form-control form-control-line" name="vcompany" required="required" value="" >
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-12"></label>
                                        <div class="col-md-12">
                                            <input type="text" placeholder="Enter Vendor Active Status" name="vstatus" required="required" class="form-control form-control-line" value="" >
                                        </div>
                                    </div>
                                  <!--  <div class="form-group">
                                        <label for="example-email" class="col-md-12"></label>
                                   ...
                                   <div class="form-group">
                                        <div class="col-sm-12">
                                            <button class="btn btn-info float-right" name="submit" type="submit">Update Info</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-block">
                                <h2 class="card-title">OPS4 Vendors Data</h2>
                ...
                <th align = "center">Vendor Email</th>
                <th align = "center">Vendor Contact</th>
                <th align = "center">Vendor Company</th>
                <th align = "center">Vendor Status</th>
        ...
        <tbody id="myTable">
                ...
                while ($employee = mysqli_fetch_assoc($result)) {
                    ...
                    echo "<td>".$employee['vendorname']."</td>";
                    echo "<td>".$employee['vendoremail']."</td>";
                    echo "<td>".$employee['vendorcontact']."</td>";
                    echo "<td>".$employee['vendorcompany']."</td>";
                    echo "<td>".$employee['vendorstatus']."</td>";



                    echo "<td><a href=\"ops4vdataedit.php?id1=$employee[id]&id=$id\"><i class='mdi mdi-table-edit'></i>Edit</a> | <a href=\"ops4vdatadelete.php?id1=$employee[id]&id=$id\" onClick=\"return confirm('Are you sure you want to delete?')\"><i class='mdi mdi-delete'></i>Delete</a></td>";
                    echo "</tr>";
