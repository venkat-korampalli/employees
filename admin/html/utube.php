...
$id = (isset($_GET['id']) ? $_GET['id'] : '');
     ...
     $sql4 = "SELECT * FROM `youtube` WHERE id=$alogin[id]";
  $result4 = mysqli_query($conn, $sql4);
  while ($utube = mysqli_fetch_assoc($result4)) {
      $remark = $utube['status'];
...
$(document).ready(function(){
  $("#myInput").on("keyup", function() {
            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-6 col-8 align-self-center">
                        <h3 class="text-themecolor m-b-0 m-t-0">YOUTUBE OPERATIONS</h3>
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                            <li class="breadcrumb-item active">Youtube Operations</li>
                    <!--        <li class="breadcrumb-item float-right"><a href="ops4vdata.php?id=<?php echo $id?>">OPS4 Vendor Data</li>
                            <li class="breadcrumb-item float-right"><a href="ops4data3.php?id=<?php echo $id?>">OPS4 Consultant Data</li> -->
                        </ol>
                    </div>
        ...
        <div class="modal-dialog">
          ...
          <!--  <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title">Youtube Remarks</h4>
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                </div>
                <div class="modal-body">
                    <p>YOUTUBE REMARKS.</p>
                    <form method="post" action="utube.php?id1=<?php echo $alogin['id']?>">
    <div class="row"> 
    REMARKS :
    <div class="col-lg-12 col-xl-12 col-md-12"> 
       <input name="remarks" class="form-control form-control-line" type="text" placeholder="Enter Remarks" value="<?php echo $id1 = $alogin['id']?>"<br/>  
      </div>
      </div><br/>
      <button class="btn btn-info float-right" name="" type="send" value="Send"><i class="mdi mdi-send"></i>&nbsp Submit</button>
      </form>
                </div>
                <div class="modal-footer">
                    <button type="button" name = "remarks" class="btn btn-default" data-dismiss="modal">Close</button>
                </div>
            </div>
                            ...
                            <div class="card-block">
                                <form action="utubesubmit.php?id=<?php echo $id?>" method="POST" enctype="multipart/form-data" class="form-horizontal form-material">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input type="text" placeholder="Enter 11 characters Youtube Video Id" class="form-control form-control-line" value="" name="videolink" >
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-12"></label>
               ...
               <?php
                while ($alogin = mysqli_fetch_assoc($result3)) {
                   ...
                   // echo "<td>".$alogin['description']."</td>";
                    ...
                    echo "<td><a href=\"approveutube.php?id1=$alogin[id]&id=$id\"  onClick=\"return confirm('Are you sure you want to Approve the request?')\"><i class='mdi mdi-check-all'></i>Approve</a> |<br> <a 
                    href=\"utubeedit.php?id1=$alogin[id]&id=$id\"  onClick=\"return confirm('Are you sure you want to add remarks?')\"><i class='mdi mdi-close'>Add Remarks</a></td>";
                 ...
                 //   echo "<td><a href=\"quickfiles2.php?file_id=$alogin[id]\"><i class='mdi mdi-download'></i>Download</a></td>";
                    echo "<td><a href=\"utubeedit.php?id1=$alogin[id]&id=$id\">Edit</a> | <a href=\"utubedelete.php?id1=$alogin[id]&id=$id\" onClick=\"return confirm('Are you sure you want to delete?')\">Delete</a></td>";
    ...
    $(e.currentTarget).find('input[name="remarks"]').val(bookId);
});
</script>
<script>
$(document).ready(function(){
