...
//$submissionstatus =$_POST['submissionstatus'];
    ...
    $sql = "INSERT INTO `ops3vendordata` (`empid`, `timestamp`, `vendorname`, `vendoremail`, `vendorcontact`, `vendorcompany`, `vendorstatus`) VALUES ('$id', '$currentTime', '$vname', '$vemail', '$vcontact', '$vcompany', '$vstatus')";
