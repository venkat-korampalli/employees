...
$sql = "SELECT * from `employee` , `ops0data1` WHERE employee.`id` = ops0data1.`empid` ORDER BY ops0data1.`id` DESC";
            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-7 col-8 align-self-center">
                        <h3 class="text-themecolor m-b-0 m-t-0">OPS0 PROJECT DATA</h3>
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                            <li class="breadcrumb-item active">OPS0 Project Data</li>
                            <li class="breadcrumb-item float-right"><a href="ops0fclientdata.php?id=<?php echo $id?>">OPS0FClient</a></li>
...
<div class="row">
        ...
        <tbody id="myTable">
                ...
                while ($employee = mysqli_fetch_assoc($result)) {
                    ...
                    echo "<td><a href=\"ops0data1edit.php?id1=$employee[id]&id=$id\"><i class='mdi mdi-table-edit'></i>Edit</a> | <a href=\"ops0data1delete.php?id1=$employee[id]&id=$id\" onClick=\"return confirm('Are you sure you want to delete?')\"><i class='mdi mdi-delete'></i>Delete</a></td>";
                    echo "</tr>";
