...
$sql = "SELECT * from `employee` , `ops3data` WHERE employee.`id` = ops3data.`empid` ORDER BY ops3data.`id` DESC";
    ...
    <div id="main-wrapper">
        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-7 col-8 align-self-center">
                        <h3 class="text-themecolor m-b-0 m-t-0">OPS3 SUBMISSION DATA</h3>
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                            <li class="breadcrumb-item active">OPS3 Submission Data</li>
                            <li class="breadcrumb-item float-right"><a href="ops3vdata.php?id=<?php echo $id?>">Vendor Data</a></li>
                            <li class="breadcrumb-item float-right"><a href="ops3bench.php?id=<?php echo $id?>">Bench Data</a></li>
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-block">
                                <h2 class="card-title">OPS3 Submission Data</h2>
            ...
            <tr>
                ...
                <th align = "center">Implemenation</th>
                <th align = "center">Vendor Name</th>
                <th align = "center">Vendor Email</th>
                <th align = "center">Vendor Number</th>
                <th align = "center">Submission Status</th>
        ...
        <tbody id="myTable">
                ...
                while ($employee = mysqli_fetch_assoc($result)) {
                    ...
                    echo "<td>".$employee['candidatename']."</td>";
                    echo "<td>".$employee['technology']."</td>";
                    echo "<td>".$employee['clientlocation']."</td>";
                    echo "<td>".$employee['candidatevisastatus']."</td>";
                    echo "<td>".$employee['rate']."</td>";
                    echo "<td>".$employee['client']."</td>";
                    echo "<td>".$employee['implementation']."</td>";
                    echo "<td>".$employee['vendorname']."</td>";
                    echo "<td>".$employee['vendoremail']."</td>";
                    echo "<td>".$employee['vendornumber']."</td>";
                    echo "<td>".$employee['submissionstatus']."</td>";
                  //echo "<td>".$employee['filename']."</td>";
                //  echo "<td>".floor($employee['size'] / 1000) . ' KB'."</td>";
                  //echo "<td>".$employee['downloads']."</td>";
                  //echo "<td><a href=\"../../filesLogic.php?file_id=$employee[id]\"><i class='mdi mdi-download'></i>Download</a></td>";



                    echo "<td><a href=\"ops3data1edit.php?id=$employee[id]\"><i class='mdi mdi-table-edit'></i>Edit</a> | <a href=\"ops3data1delete.php?id=$employee[id]\" onClick=\"return confirm('Are you sure you want to delete?')\"><i class='mdi mdi-delete'></i>Delete</a></td>";
                    echo "</tr>";
