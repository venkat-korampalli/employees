...
require_once ('process/session.php');
 ...
 if(!isset($_SESSION['userid'])){
    ...
    $sql5 = "SELECT * FROM `ops4bdmdata` WHERE 1";
            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-7 col-8 align-self-center">
                        <h3 class="text-themecolor">OPS4 BDM MANAGERS DATA</h3>
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="">Home</a></li>
                            <li class="breadcrumb-item active">OPS4 Bdm Managers Data</li>
                            ...
                            <li class="breadcrumb-item float-right"><a href="ops4vdata.php?id=<?php echo $id?>"> Vendors</a></li>
                        </ol>
                    </div>
                    ...
                    <div class="col-lg-12 col-xlg-3 col-md-5">
                        <div class="card">
                            <div class="card-block">
                                <form action="ops4bdmsubmit.php?id=<?php echo $id?>" method="POST" enctype="multipart/form-data" class="form-horizontal form-material">
                                    <div class="form-group">
                                        <label class="col-md-12"></label>
                                        <div class="col-md-12">
                                            <input type="text" placeholder="Enter FullName" class="form-control form-control-line" value="" name="managername" >
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-12"></label>
                                        <div class="col-md-12">
                                            <input type="text" placeholder="Enter Contact Number ( WA(Yes / No) )" class="form-control form-control-line" name="contactnumber" value="" >
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-12"></label>
                                        <div class="col-md-12">
                                            <input type="text" placeholder="Enter End Client" name="endclient" required="required" class="form-control form-control-line" value="" >
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="example-email" class="col-md-12"></label>
                                        <div class="col-md-12">
                                            <input type="text" name="activereqs" placeholder="Enter Active Requirements" class="form-control form-control-line" value=""  id="example-email" >
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-12"></label>
                                        <div class="col-md-12">
                                            <input type="text" placeholder="Enter Deal (Ok / Still Waiting)" name="deal" required="required" class="form-control form-control-line" value="" >
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-12"></label>
                                        <div class="col-md-12">
                                            <input type="text" placeholder="Enter Po's Given" name="posgiven" required="required" class="form-control form-control-line" value="" >
                                        </div>
                                    </div>
                                  <!--  <div class="form-group">
                                        <label for="example-email" class="col-md-12"></label>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12 col-xlg-9 col-md-7">
                        <div class="card">
                            <div class="card-block">
                                <h4 class="card-title">OPS4 Bdm Data</h4>
                ...
                <th align = "center">Manager Name</th>
                <th align = "center">Email Id</th>
                <th align = "center">Contact Number</th>
                <th align = "center">End Client</th>
                <th align = "center">Active Requirements</th>
                <th align = "center">Deal</th>
                <th align = "center">PO's Given</th>
               ...
               <?php
                while ($alogin = mysqli_fetch_assoc($result5)) {
                    ...
                    echo "<td>".$alogin['managernamename']."</td>";
                    echo "<td>".$alogin['email']."</td>";
                    echo "<td>".$alogin['contactnumber']."</td>";
                    echo "<td>".$alogin['endclient']."</td>";
                    echo "<td>".$alogin['activereqs']."</td>";
                    echo "<td>".$alogin['deal']."</td>";
                    echo "<td>".$alogin['posgiven']."</td>";
