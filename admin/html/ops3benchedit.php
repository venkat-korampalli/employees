...
$result = mysqli_query($conn, "UPDATE `ops3benchdata` SET `startdate`='$startdate', `name`='$name',`technology`='$technology',`email`='$email',`number`='$number',`visa`='$visa', `reference`='$reference',`assigned`='$assigned' WHERE id=$id1");
...
<?php
	$id = (isset($_GET['id']) ? $_GET['id'] : '');
    $id1 = (isset($_GET['id1']) ? $_GET['id1'] : '');
	$sql = "SELECT * from `ops3benchdata` WHERE id=$id1";
	$result = mysqli_query($conn, $sql);
	if($result){
	...
	<div class="page-wrapper bg-blue p-t-100 p-b-100 font-robo">
        <div class="wrapper wrapper--w680">
            <div class="card card-1">
                ...
                <div class="card-body">
                    <h2 class="title">UPDATE OPS3 BENCH INFO</h2>
                    <form id = "registration" action="ops3benchedit.php?id1=<?php echo $id1;?>&id=<?php echo $id;?>" method="POST">
                     <!--   <div class="col-2">
                                        <label for="" class="col-md-12">Start Date</label>
                                        <div class="input-group">
                                     <input type="date" name="startdate" class="input--style-1" value="<?php echo $startdate;?>">
                                        </div>
                                    </div> -->
                                <div class="input-group">
                                    <label for="" class="col-md-12">Start Date</label>
