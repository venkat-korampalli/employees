...
$sql = "SELECT * from `employee` , `ops3data2` WHERE employee.`id` = ops3data2.`empid` ORDER BY ops3data2.`id` DESC";
    ...
    <div id="main-wrapper">
        ...
        <tbody id="myTable">
                ...
                while ($employee = mysqli_fetch_assoc($result)) {
                    ...
                    echo "<td><a href=\"ops3wdataedit.php?id1=$employee[id]&id=$id\"><i class='mdi mdi-table-edit'></i>Edit</a> | <a href=\"ops3wdatadelete.php?id1=$employee[id]&id=$id\" onClick=\"return confirm('Are you sure you want to delete?')\"><i class='mdi mdi-delete'></i>Delete</a></td>";
                    echo "</tr>";
