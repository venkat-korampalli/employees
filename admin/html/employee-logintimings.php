...
$sql = "SELECT * from `userlog1` , `employee` WHERE employee.`id` = userlog1.`empid` ORDER BY logindate DESC";
...
<head>
    ...
    <title>SuccorTechnologies | Employee Management | Employee LogTimings</title>
    <!-- Bootstrap Core CSS -->
            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 col-8 align-self-center">
                        <h3 class="text-themecolor m-b-0 m-t-0">EMPLOYEE OPS1-2 LOGIN-OUT TIMINGS</h3>
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                            <li class="breadcrumb-item active">Employee OPS1-2 Login-Out Timings</li>
                        </ol>
                    </div>
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-block">
                                <h2 class="card-title">Employees OPS1 & 2 Work Login and Out Timings </h2>
