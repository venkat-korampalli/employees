...
$result = mysqli_query($conn, "UPDATE `ops4wglconsultantdata` SET `name`='$name',`technology`='$technology',`visa`='$visa',`contract`='$contract',`certification`='$certification',`email`='$email',`number`='$number',`linkedin`='$linkedin',`consultantname`='$consultantname',`recruitername`='$recruitername',`experience`='$experience' WHERE id=$id1");
...
<?php
	$id1 = (isset($_GET['id1']) ? $_GET['id1'] : '');
    $id = (isset($_GET['id']) ? $_GET['id'] : '');
	$sql = "SELECT * from `ops4wglconsultantdata` WHERE id=$id1";
	$result = mysqli_query($conn, $sql);
	if($result){
	...
	<div class="page-wrapper bg-blue p-t-100 p-b-100 font-robo">
        <div class="wrapper wrapper--w680">
            <div class="card card-1">
                ...
                <div class="card-body">
                    <h2 class="title">UPDATE OPS4 WGL CONSULTANT INFO</h2>
                    <form id = "registration" action="ops4wdata3edit.php?id1=<?php echo $id1;?>&id=<?php echo $id;?>" method="POST">
