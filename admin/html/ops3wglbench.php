...
require_once ('process/session.php');
 ...
 if(!isset($_SESSION['userid'])){
    ...
    $sql5 = "SELECT * FROM `ops3wglbenchdata` WHERE 1";
            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-7 col-8 align-self-center">
                        <h3 class="text-themecolor">OPS3-WGL BENCH CONSULTANTS</h3>
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="">Home</a></li>
                            <li class="breadcrumb-item active">OPS3-wgl Bench Consultants</li>
                            ...
                            <li class="breadcrumb-item float-right"><a href="subcount.php?id=<?php echo $id?>"> Subcount </a></li>
                        </ol>
                    </div>
                    ...
                    <div class="col-lg-12 col-xlg-12 col-md-5">
                        <div class="card">
                            <div class="card-block">
                                <form action="ops3wglbenchsubmit.php?id=<?php echo $id?>" method="POST" enctype="multipart/form-data" class="form-horizontal form-material">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12 col-xlg-12 col-md-7">
                        <div class="card">
                            <div class="card-block">
                                <h4 class="card-title">OPS3-Wgl Bench Consultant</h4>
               ...
               <?php
                while ($alogin = mysqli_fetch_assoc($result5)) {
                    ...
                    echo "<td><a href=\"ops3wglbenchedit.php?id1=$alogin[id]&id=$id\">Edit</a> | <a href=\"ops3wglbenchdelete.php?id1=$alogin[id]&id=$id\" onClick=\"return confirm('Are you sure you want to delete?')\">Delete</a></td>";
