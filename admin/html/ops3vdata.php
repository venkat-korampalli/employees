...
$sql = "SELECT * from `ops3vendordata` ORDER BY ops3vendordata.`id` DESC";
            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-7 col-8 align-self-center">
                        <h3 class="text-themecolor m-b-0 m-t-0">OPS3 VENDORS DATA</h3>
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                            <li class="breadcrumb-item active">OPS3 Vendors Data</li>
                            <li class="breadcrumb-item float-right"><a href="OPS3data.php?id=<?php echo $id?>"> Submission </a></li>
                            <li class="breadcrumb-item float-right"><a href="ops3bench.php?id=<?php echo $id?>"> Bench </a></li>
                    ...
                    <div class="col-lg-12 col-xlg-3 col-md-5">
                        <div class="card">
                            <div class="card-block">
                                <form action="ops3vdatasubmit.php?id=<?php echo $id?>" method="POST" class="form-horizontal form-material">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-block">
                                <h2 class="card-title">OPS3 Vendors Data</h2>
        ...
        <tbody id="myTable">
                ...
                while ($employee = mysqli_fetch_assoc($result)) {
                   ...
                   // echo "<td><img src='../html/process/".$employee['pic']."' height = 60px width = 60px></td>";
                    ...
                    echo "<td><a href=\"ops3vdataedit.php?id1=$employee[id]&id=$id\"><i class='mdi mdi-table-edit'></i>Edit</a> | <a href=\"ops3vdatadelete.php?id1=$employee[id]&id=$id\" onClick=\"return confirm('Are you sure you want to delete?')\"><i class='mdi mdi-delete'></i>Delete</a></td>";
                    echo "</tr>";
