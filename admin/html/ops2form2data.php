...
$sql = "SELECT * from `employee` , `ops2form2` WHERE employee.`id` = ops2form2.`empid` ORDER BY ops2form2.`id` DESC";
    ...
    <div id="main-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 col-8 align-self-center">
                        <h3 class="text-themecolor m-b-0 m-t-0">OPS2 PROFILES DATA</h3>
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                            <li class="breadcrumb-item active">OPS2 Profiles Data</li>
                            <li class="breadcrumb-item float-right"><a href="ops2form1data.php?id=<?php echo $id?>">OPS2 Client Data</li>
                        </ol>
                    </div>
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-block">
                                <h2 class="card-title">OPS2 Profiles Data</h2>
                                <h6 class="card-subtitle">Always <code>.remember</code></h6>
                                <div class="table-responsive">
                                    <table class="table table-striped table-hover table-bordered table-wrapper-scroll-y my-custom-scrollbar" id="ops2-2">
                ...
                <th align = "center">Candidate Number</th>
                <th align = "center">Email</th>
                <th align = "center">Status</th>
                <th align = "center">Feedback</th>
               <!-- <th align = "center">Web Link</th>
                <th align = "center">Sourced Profiles</th> -->
        ...
        <tbody id="myTable">
                ...
                while ($employee = mysqli_fetch_assoc($result)) {
                    ...
                    echo "<td>".$employee['candidatenumber']."</td>";
                    echo "<td>".$employee['email']."</td>";
                    echo "<td>".$employee['status']."</td>";
                    echo "<td>".$employee['feedback']."</td>";
                   // echo "<td>".$employee['weblink']."</td>";
                    //echo "<td>".$employee['sourcedprofiles']."</td>";

                    



                    echo "<td><a href=\"ops2data2edit.php?id1=$employee[id]&id=$id\"><i class='mdi mdi-table-edit'></i>Edit</a> | <a href=\"ops2data2delete.php?id1=$employee[id]&id=$id\" onClick=\"return confirm('Are you sure you want to delete?')\"><i class='mdi mdi-delete'></i>Delete</a></td>";
                    echo "</tr>";
