...
$activereqs = $_POST['activereqs'];
$deal = $_POST['deal'];
$posgiven = $_POST['posgiven'];
...
//$submissionstatus =$_POST['submissionstatus'];
    ...
    $sql = "INSERT INTO `ops4bdmdata` (`admin`, `timestamp`, `managername`, `email`, `contactnumber`, `endclient`, `activereqs`, `deal`, `posgiven`) VALUES ('$id', '$currentTime', '$managername', '$email', '$contactnumber', '$endclient', '$activereqs', '$deal', '$posgiven')";
