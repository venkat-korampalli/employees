...
$id = $_GET['id'];
$sql = "SELECT * from `employee` , `ops2form2` WHERE employee.`id` = ops2form2.`empid` AND ops2form2.`empid` = $id";
    ...
    <div id="main-wrapper">
        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <th align = "center">Contacted person</th>
        ...
        <tbody>
                ...
                while ($employee = mysqli_fetch_assoc($result)) {
                    ...
                    echo "<td>".$employee['contactedperson']."</td>";
                    echo "<td>".$employee['number']."</td>";
                    echo "<td>".$employee['emailid']."</td>";
                    echo "<td>".$employee['source']."</td>";
                    echo "<td>".$employee['status']."</td>";
                    echo "<td>".$employee['callstatus']."</td>";
