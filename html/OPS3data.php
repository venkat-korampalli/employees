...
$id = $_GET['id'];
$sql = "SELECT * from `employee` , `ops12345` WHERE employee.`id` = ops12345.`empid` AND ops12345.`empid` = $id";
    ...
    <div id="main-wrapper">
        ...
        <tbody>
                ...
                while ($employee = mysqli_fetch_assoc($result)) {
                   ...
                   // echo "<td><a href=\"ops3dataedit.php?id1=$employee[id]&id=$id\"><i class='mdi mdi-table-edit'></i>Edit</a> | <a href=\"delete.php?id=$employee[id]\" onClick=\"return confirm('Are you sure you want to delete?')\"><i class='mdi mdi-delete'></i>Delete</a></td>";
                  //  echo "</tr>";
