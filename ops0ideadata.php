...
$id = $_GET['id'];
$sql = "SELECT * from `employee` , `ops0idea` WHERE employee.`id` = ops0idea.`empid` AND ops0idea.`empid` = $id ORDER BY ops0idea.`id` DESC";
    ...
    <div id="main-wrapper">
        ...
        <tbody id="myTable">
                ...
                while ($employee = mysqli_fetch_assoc($result)) {
                    ...
                    echo "<td><a href=\"ops0ideaedit.php?id1=$employee[id]&id=$id\"><i class='mdi mdi-table-edit'></i>Edit</a></td>";
