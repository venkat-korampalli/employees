...
$id = $_GET['id'];
$sql = "SELECT * from `employee` , `ops4consultantdata` WHERE employee.`id` = ops4consultantdata.`empid` AND ops4consultantdata.`empid` = $id ORDER BY ops4consultantdata.`id` DESC";
...
$(document).ready(function() {
    ...
    <div id="main-wrapper">
        ...
        <tbody id="myTable">
                ...
                while ($employee = mysqli_fetch_assoc($result)) {
                    ...
                    echo "<td><a href=\"ops4data3edit.php?id1=$employee[id]&id=$id\"><i class='mdi mdi-table-edit'></i>Edit</a></td>";
                    // | <a href=\".php?id1=$employee[id]&id=$id\" onClick=\"return confirm('Are you sure you want to delete?')\"><i class='mdi mdi-delete'></i>Delete</a>
                    echo "</tr>";
    ...
    <script type="text/javascript" src="admin/html/datatables/js/jquery.dataTables.min.js"></script>
</body>
