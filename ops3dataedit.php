...
$sql = "SELECT * FROM `ops3data` WHERE 1";
...
$result = mysqli_query($conn, "UPDATE `ops3data` SET `submissionstatus`='$submissionstatus' WHERE id=$id1");
...
<?php
	$id1 = (isset($_GET['id1']) ? $_GET['id1'] : '');
    $id = (isset($_GET['id']) ? $_GET['id'] : '');
	$sql = "SELECT * from `ops3data` WHERE id=$id1";
	$result = mysqli_query($conn, $sql);
	if($result){
        ...
        <div class="wrapper wrapper--w680">
            <div class="card card-1">
                ...
                <div class="card-body">
                    ...
                    <form id = "registration" action="ops3dataedit.php?id1=<?php echo $id1;?>&id=<?php echo $id;?>" method="POST">
