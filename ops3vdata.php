...
$id = $_GET['id'];
$sql = "SELECT * from `employee` , `ops3vendordata` WHERE employee.`id` = ops3vendordata.`empid` AND ops3vendordata.`empid` = $id ORDER BY ops3vendordata.`id` DESC";
    ...
    <div id="main-wrapper">
        ...
        <tbody id="myTable">
                ...
                while ($employee = mysqli_fetch_assoc($result)) {
                    ...
                    echo "<td><a href=\"ops3vdataedit.php?id1=$employee[id]&id=$id\"><i class='mdi mdi-table-edit'></i>Edit</a></td>";
                    // | <a href=\"ops3vdatadelete.php?id1=$employee[id]&id=$id\" onClick=\"return confirm('Are you sure you want to delete?')\"><i class='mdi mdi-delete'></i>Delete</a>
                    echo "</tr>";
