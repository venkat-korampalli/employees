                            ...
                            <div class="card-block">
                                <center class="m-t-30"> <img src="admin/html/process/<?php echo $pic;?>" class="img-circle" width="150" />
                                    ...
                                    <div class="row text-center justify-content-md-center">
                                        <div class="col-4"><a href="" class="link"><i class="icon-people"></i> <font class="font-medium"><br><?php echo $empid;?></font></a></div>
                                        <div class="col-4"><a href="" class="link"><i class="icon-picture"></i> <font class="font-medium"><br><?php echo $empops;?></font></a></div>
                                    </div>
                                </center>
                            </div>
                        </div>
                            ...
                            <div class="card-block">
                                ...
                                <form action="myprofileup.php?id=<?php echo $id?>" method="POST" enctype="multipart/form-data" class="form-horizontal form-material">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                     <input type="date" placeholder="BIRTHDATE" name="birthday" required="required" class="form-control form-control-line" value="<?php echo $birthday;?>" readonly>
                                        </div>
                                    </div>
                                     <div class="form-group">
