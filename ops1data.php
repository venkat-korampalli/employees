...
$id = $_GET['id'];
$sql = "SELECT * from `employee` , `ops1data` WHERE employee.`id` = ops1data.`empid` AND ops1data.`empid` = $id ORDER BY ops1data.`id` DESC";
    ...
    <div id="main-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 col-8 align-self-center">
                        <h3 class="text-themecolor m-b-0 m-t-0">OPS1 SESSION DATA</h3>
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="index.php?id=<?php echo $id?>">Home</a></li>
                            <li class="breadcrumb-item active">OPS1 Session Data</li>
                        </ol>
                    </div>
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-block">
                                <h2 class="card-title">OPS1 Session Data</h2>
                ...
                <th align = "center">Candidate Email</th>
                <th align = "center">Candidate Number</th>
                <th align = "center">Deal Amount</th>
                <th align = "center">Resource Amount</th>
        ...
        <tbody id="myTable">
                ...
                while ($employee = mysqli_fetch_assoc($result)) {
                    ...
                    echo "<td>".$employee['candidateemail']."</td>";
                    echo "<td>".$employee['candidatenumber']."</td>";
                    echo "<td>".$employee['dealamount']."</td>";
                    echo "<td>".$employee['resourceamount']."</td>";
                    echo "<td>".$employee['status']."</td>";



                    echo "<td><a href=\"ops1edit.php?id1=$employee[id]&id=$id\"><i class='mdi mdi-table-edit'></i>Edit</a></td>";
                    // | <a href=\"ops1delete.php?id1=$employee[id]&id=$id\" onClick=\"return confirm('Are you sure you want to delete?')\"><i class='mdi mdi-delete'></i>Delete</a>
                    echo "</tr>";
