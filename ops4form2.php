            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 col-8 align-self-center">
                        <h3 class="text-themecolor">OPS4 VENDORS</h3>
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="">Home</a></li>
                            <li class="breadcrumb-item active">OPS4 Vendors</li>
                        </ol>
                    </div>
                    ...
                    <div class="col-lg-12 col-xlg-3 col-md-5">
                        <div class="card">
                            <div class="card-block">
                                <form action="ops4vendordata.php?id=<?php echo $id?>" method="POST" class="form-horizontal form-material">
